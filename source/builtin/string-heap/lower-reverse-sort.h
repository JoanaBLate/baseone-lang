...
String createStringToLowerHeap(String *string)
{
    String newString = createStringCloneHeap(string);
...
String createStringToUpperHeap(String *string)
{
    String newString = createStringCloneHeap(string);
...
String createStringToOppositeCaseHeap(String *string)
{
    String newString = createStringCloneHeap(string);
...
String createStringReverseHeap(String *string)
{
    String newString = createStringCloneHeap(string);
...
String createStringSortHeap(String *string) // slow 
{
    String newString = createStringCloneHeap(string);
