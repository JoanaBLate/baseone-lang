...
// The main BaseOne file must be declared as member of the virtual package "main".

// This file must contain the function "main". 

// The function main is a special function:
// - it must be the first declared function of the file
...
//   (that's why the name is "main", not "init" or "start")
